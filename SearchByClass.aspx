<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SearchByClass.aspx.vb" Inherits="frmPaymentPerDate"  %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <tr>
                        <td align="right" class="style14">
                            Class Name :</td>
                        <td class="style4">
                            <asp:DropDownList ID="drpClassName" runat="server" Height="25px" Width="200px">
                            </asp:DropDownList>
                        </td>
                        <td class="style2">
